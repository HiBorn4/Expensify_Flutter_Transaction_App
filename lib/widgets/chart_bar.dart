          ...
          SizedBox(
            ...
            child: Stack(
              children: <Widget>[
                ...
                // The heightFactor property of the FractionallySizedBox widget is set to (1 - spendingPctOfTotal),
                // which determines the height of the remaining portion of the bar. The container also has
                // a background color and borderRadius property.
                FractionallySizedBox(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      border: Border.all(
                          color: Colors.black,
                          width: 2.0), // Increase the width to desired value
                      color: Colors.white,
                      borderRadius: BorderRadius.circular(10),
                    ),
                  ),
